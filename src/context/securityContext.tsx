...
const SecurityProvider: React.FC = ({ children }) => {
  ...
  function permissionsByModule(module:SecurityModule) {
    ...
    if (module === SecurityModule.configuration){
      return "CFGLAW,CFGEMP,CFGOPP,CFGTHIRD,CFGGRTHD,CFGSTATE,CFGHOLID,CFGINDEC,CFGDCMIE,CACINFO,CACRPT,CACINFFI,CFGDCMEM,CFGDCMIE,CFGWKF,CFGWKFCD,CFGWKFEX";
    }
   
    // Financial Permissions access Codes
    if (module === SecurityModule.financial){
      return "FINMAIN,FINCARCO,FINCATG,FINCCUST,FINACCO,FINPAYFO,CFGSERTP,FATFINST,FINRPT1,FINRPT2,FINRPT3,FINRPT4,FINRPT5,FATCTTO,FINREGCO,FININTEG";
    }
  }
