...
const FinancialHonorariumList: React.FC = () => {
...
const handleGenerateReport = useCallback(async() => {
  ...
  if (period == "all" && peopleValue == ""){
    addToast({type: "info", title: "Operação NÃO realizada", description: `Para usar todo o período, selecione um item no filtro de Pessoas`})
  ...
  try {
    ...
    const response = await api.post('/Financeiro/GerarRelatorioHonorario', {
      accountId,
...
}, [addToast, accountId, peopleId, dtaCustomStart, dtaCustomEnd, layout, situation, period, categoryId, accountValue]); 
...
const handleRemoveItemCategory = (category) => {
  ...
  return (
    ...
    <Container>
      ...
      <Content>
        <header style={{fontSize:"15px"}}>Selecione um ou mais filtros para relatório de honorários</header>
        ...
        <Form> 
          <section id="dados" style={{width:"100%"}}>
            ...
            <div>
              ...
              <div style={{marginLeft:"1%", width:"98%", marginTop:"1.5%"}}>
                <label htmlFor="type">
                  Periodo
                  <select
                    style={{width:"100%", backgroundColor:"white"}}
...
export default FinancialHonorariumList;
