...
const MatterDemandReport: React.FC = () => {
...
const [reportLayout, setReportLayout] = useState<string>("shortRecord")
...
const LoadResponsible = async (userName?: string) => {
 ...
 const handleGenerateReport = useCallback(async() => {
  ...
  try {
    ...
    const response = await api.post('/Processo/GerarRelatorioMatterDemand', {
        ...
        <Form ref={formRef} onSubmit={handleSubmit(console.log)}> 
          ...
          <section id="dados">
            ...
            <div style={{ width:"99%", display:"inline-block", marginLeft:"1%"}}>
              ...
              <div style={{display:"flex", marginLeft:"1%", width:"95%", marginTop:"3.5%"}}>
                <div style={{width:"100%"}}>
              ...
              <div style={{marginLeft:"1%", width:"95.5%", marginTop:"3%"}}>
                <label htmlFor="type" style={{width:"100%"}}>
                  ...
                  >
                    <option value="shortRecord">Lista Pedidos</option>
...
export default MatterDemandReport;
