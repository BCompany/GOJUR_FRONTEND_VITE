...
const Monitoring: React.FC = () => {
  ...
  async function LoadStatusOperation() {
    const response = await api.get<StatusOperationDTO[]>('/LegalData/StatusOperacao', {params: { token }});
    ...
    setSuperiorInstanceListBase(
      response.data.filter(
        x => x.scrapperAlias == 'STF' || x.scrapperAlias == 'TST' || x.scrapperAlias == 'STJ',
      ),
    );
  ...
  const optionsMonitoringFilter = [
    { value: 'SJ', label: 'Consulta Logada' },
    ...
    <>
      <Container id="Container">
        ...
        <TollBar id="TollBar">
          ...
          <div className="filters">
            <div id="DivMulti" style={{ marginTop: '-5px' }}>
              <label htmlFor="type" style={{ float: 'left', width: '200px', marginTop: '-6px' }}>
                Status
                <MultiSelect
                  ...
                  overrideStrings={{selectSomeItems: 'Filtragem Rápida', selectAll: "Selecionar tudo", search: "Buscar", selectAllFiltered: "Selecionar todos (filtrados)"}}
                />
              </label>
            </div>
        ...
        <Center id="Center">
          ...
          <div className="info">A consulta logada utiliza as credenciais para monitorar processos em segredo de justiça ou tribunais que não fornecem consulta pública</div>
                  ...
                  <tr>
                    ...
                    <th style={{ width: '10%' }}>
                      ...
                      <BsFillInfoSquareFill
                        style={{color:'#EDEDED'}}
                        title="A consulta logada utiliza as credenciais para monitorar processos em segredo de justiça ou tribunais que não fornecem consulta pública"
                      />
                    </th>
